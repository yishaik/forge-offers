...
(function (root) {
  ...
  var I18N = {
    en: {
      ...
      takeName: "Collect",
      perMo: "/ mo",
      whenPay: "when you collect",
      free1: "3 offers a month",
      free2: "Shareable client page",
      free3: "English + Hebrew",
      pro1: "Unlimited offers",
      pro2: "Your mark on the page",
      pro3: "Saved clients & repeats",
      take1: "Optional — only if you take payment in Forge",
      take2: "Keep invoicing outside if you prefer",
      take3: "No fee on a shared link",
    ...
    he: {
      ...
      pro3: "לקוחות שמורים וחוזרים",
      take1: "רשות — רק אם גובים דרך Forge",
      take2: "אפשר להמשיך לחייב בחוץ",
      take3: "אין עמלה על קישור משותף",
      footCta: "צרו הצעה",
      back: "בית",
      builderKicker: "בנאי",
